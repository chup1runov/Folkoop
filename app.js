...
const pilotMessages = {
  sv:{aboutLabel:'Om Sverinav',title:'Om Sverinav',intro:'Sverinav är ett oberoende civic-tech-projekt som gör det enklare att hitta rätt väg i det offentliga Sverige.',indTitle:'Inte en myndighet',indText:'Sverinav är inte en myndighet och representerar inte Göteborgs Stad, Trafikverket eller Sveriges riksdag. Officiella ärenden skickas i respektive myndighets egen tjänst.',privacyTitle:'Integritet',privacy1:'Ingen inloggning eller personnummer krävs i pilotläget.',privacy2:'Position begärs bara när du själv startar en platsbaserad kontroll och sparas inte av Sverinav.',privacy3:'Språkval sparas lokalt i webbläsaren. Feedback lämnas bara när du själv väljer att dela den.',sourcesTitle:'Källor',sourcesText:'Livefunktioner använder officiella källor och länkar vidare till originalet.',version:'Version',code:'Publik källkod',feedbackTitle:'Hjälp oss testa',feedbackIntro:'Beskriv kort vad du försökte göra och vad som hände. Inga platsdata läggs till automatiskt.',task:'Vad försökte du göra?',result:'Lyckades du?',yes:'Ja',partly:'Delvis',no:'Nej',notes:'Vad fungerade bra eller dåligt?',share:'Dela feedback',copy:'Kopiera feedback',shared:'Delningsmenyn öppnades.',copied:'Feedback kopierad.',technical:'Rapportera tekniskt fel på GitHub',feedbackPrivacy:'Sverinav har ingen feedbackserver. Du väljer själv vart texten skickas.'},
  en:{aboutLabel:'About Sverinav',title:'About Sverinav',intro:'Sverinav is an independent civic-tech project that makes it easier to find the right path through Sweden’s public services.',indTitle:'Not a public authority',indText:'Sverinav is not a public authority and does not represent the City of Gothenburg, Trafikverket or the Swedish Parliament. Official cases are submitted in the relevant authority’s own service.',privacyTitle:'Privacy',privacy1:'No account or personal identity number is required in the pilot.',privacy2:'Location is requested only when you start a location-based check and is not stored by Sverinav.',privacy3:'Language choice is stored locally in the browser. Feedback leaves the browser only when you choose to share it.',sourcesTitle:'Sources',sourcesText:'Live features use official sources and link to the original.',version:'Version',code:'Public source code',feedbackTitle:'Help us test',feedbackIntro:'Briefly describe what you tried to do and what happened. No location data is added automatically.',task:'What were you trying to do?',result:'Did it work?',yes:'Yes',partly:'Partly',no:'No',notes:'What worked well or badly?',share:'Share feedback',copy:'Copy feedback',shared:'Share menu opened.',copied:'Feedback copied.',technical:'Report a technical issue on GitHub',feedbackPrivacy:'Sverinav has no feedback server. You choose where the text is sent.'},
  ar:{aboutLabel:'حول Sverinav',title:'حول Sverinav',intro:'Sverinav مشروع civic-tech مستقل يساعد على إيجاد الطريق الصحيح في الخدمات العامة السويدية.',indTitle:'ليست جهة حكومية',indText:'Sverinav ليست جهة حكومية ولا تمثل بلدية غوتنبرغ أو Trafikverket أو البرلمان السويدي. تُرسل المعاملات الرسمية في خدمة الجهة الرسمية نفسها.',privacyTitle:'الخصوصية',privacy1:'لا يلزم حساب أو رقم شخصي في النسخة التجريبية.',privacy2:'يُطلب الموقع فقط عندما تبدأ بنفسك فحصاً يعتمد على الموقع ولا يحفظه Sverinav.',privacy3:'يُحفظ اختيار اللغة محلياً في المتصفح. لا تغادر الملاحظات المتصفح إلا عندما تختار مشاركتها.',sourcesTitle:'المصادر',sourcesText:'تستخدم الوظائف المباشرة مصادر رسمية وتربط بالمصدر الأصلي.',version:'الإصدار',code:'الكود المصدري العام',feedbackTitle:'ساعدنا في الاختبار',feedbackIntro:'صف بإيجاز ما حاولت فعله وما حدث. لا تتم إضافة بيانات الموقع تلقائياً.',task:'ماذا كنت تحاول أن تفعل؟',result:'هل نجح؟',yes:'نعم',partly:'جزئياً',no:'لا',notes:'ما الذي عمل جيداً أو بشكل سيئ؟',share:'مشاركة الملاحظات',copy:'نسخ الملاحظات',shared:'تم فتح قائمة المشاركة.',copied:'تم نسخ الملاحظات.',technical:'الإبلاغ عن مشكلة تقنية على GitHub',feedbackPrivacy:'لا يملك Sverinav خادم ملاحظات. أنت تختار أين يتم إرسال النص.'},
  so:{aboutLabel:'Ku saabsan Sverinav',title:'Ku saabsan Sverinav',intro:'Sverinav waa mashruuc civic-tech madax-bannaan oo fududeeya helidda jidka saxda ah ee adeegyada dadweynaha Sweden.',indTitle:'Ma aha hay’ad dowladeed',indText:'Sverinav ma aha hay’ad dowladeed mana matasho Göteborgs Stad, Trafikverket ama baarlamaanka Sweden. Arrimaha rasmiga ah waxaa lagu diraa adeegga hay’adda lafteeda.',privacyTitle:'Asturnaanta',privacy1:'Akoon ama personnummer looma baahna tijaabada.',privacy2:'Goobta waxaa la codsadaa oo keliya marka aad bilowdo hubin ku salaysan goobta mana kaydiyo Sverinav.',privacy3:'Luqadda waxaa lagu kaydiyaa browser-ka. Feedback-ku wuxuu baxaa oo keliya marka aad doorato inaad wadaagto.',sourcesTitle:'Ilaha',sourcesText:'Qaybaha live-ku waxay isticmaalaan ilo rasmi ah waxayna ku xiraan asalka.',version:'Nooca',code:'Koodka dadweynaha',feedbackTitle:'Naga caawi tijaabada',feedbackIntro:'Si kooban u sheeg waxaad isku dayday iyo waxa dhacay. Goobta si toos ah looguma darin.',task:'Maxaad isku dayaysay?',result:'Ma shaqeysay?',yes:'Haa',partly:'Qayb ahaan',no:'Maya',notes:'Maxaa si fiican ama xun u shaqeeyay?',share:'Wadaag feedback',copy:'Nuqul feedback',shared:'Liiska wadaagista waa furmay.',copied:'Feedback waa la nuqulay.',technical:'Ka warbixi cilad farsamo GitHub',feedbackPrivacy:'Sverinav ma laha feedback server. Adiga ayaa dooranaya halka qoraalka loo diro.'},
  fa:{aboutLabel:'درباره Sverinav',title:'درباره Sverinav',intro:'Sverinav یک پروژه مستقل civic-tech است که پیدا کردن مسیر درست در خدمات عمومی سوئد را ساده‌تر می‌کند.',indTitle:'نهاد دولتی نیست',indText:'Sverinav نهاد دولتی نیست و نماینده شهرداری یوتبری، Trafikverket یا پارلمان سوئد نیست. امور رسمی در سرویس خود نهاد مربوط ارسال می‌شوند.',privacyTitle:'حریم خصوصی',privacy1:'در نسخه آزمایشی حساب یا personnummer لازم نیست.',privacy2:'موقعیت فقط وقتی درخواست می‌شود که خودتان بررسی مکانی را شروع کنید و توسط Sverinav ذخیره نمی‌شود.',privacy3:'انتخاب زبان فقط در مرورگر ذخیره می‌شود. بازخورد فقط وقتی از مرورگر خارج می‌شود که خودتان آن را به اشتراک بگذارید.',sourcesTitle:'منابع',sourcesText:'قابلیت‌های زنده از منابع رسمی استفاده می‌کنند و به منبع اصلی پیوند می‌دهند.',version:'نسخه',code:'کد منبع عمومی',feedbackTitle:'به ما در آزمایش کمک کنید',feedbackIntro:'کوتاه بنویسید چه کاری انجام دادید و چه اتفاقی افتاد. موقعیت به‌طور خودکار اضافه نمی‌شود.',task:'چه کاری می‌خواستید انجام دهید؟',result:'آیا کار کرد؟',yes:'بله',partly:'تا حدی',no:'خیر',notes:'چه چیزی خوب یا بد کار کرد؟',share:'اشتراک بازخورد',copy:'کپی بازخورد',shared:'منوی اشتراک باز شد.',copied:'بازخورد کپی شد.',technical:'گزارش مشکل فنی در GitHub',feedbackPrivacy:'Sverinav سرور بازخورد ندارد. شما انتخاب می‌کنید متن کجا ارسال شود.'},
  fi:{aboutLabel:'Tietoa Sverinavista',title:'Tietoa Sverinavista',intro:'Sverinav on itsenäinen civic-tech-hanke, joka helpottaa oikean reitin löytämistä Ruotsin julkisissa palveluissa.',indTitle:'Ei viranomainen',indText:'Sverinav ei ole viranomainen eikä edusta Göteborgin kaupunkia, Trafikverketiä tai Ruotsin valtiopäiviä. Viralliset asiat lähetetään viranomaisen omassa palvelussa.',privacyTitle:'Tietosuoja',privacy1:'Pilotissa ei tarvita tiliä tai henkilötunnusta.',privacy2:'Sijaintia pyydetään vain, kun käynnistät sijaintiin perustuvan tarkistuksen, eikä Sverinav tallenna sitä.',privacy3:'Kielivalinta tallennetaan selaimeen. Palaute poistuu selaimesta vain, kun päätät jakaa sen.',sourcesTitle:'Lähteet',sourcesText:'Live-toiminnot käyttävät virallisia lähteitä ja linkittävät alkuperäiseen.',version:'Versio',code:'Julkinen lähdekoodi',feedbackTitle:'Auta testaamaan',feedbackIntro:'Kerro lyhyesti mitä yritit tehdä ja mitä tapahtui. Sijaintia ei lisätä automaattisesti.',task:'Mitä yritit tehdä?',result:'Toimiko se?',yes:'Kyllä',partly:'Osittain',no:'Ei',notes:'Mikä toimi hyvin tai huonosti?',share:'Jaa palaute',copy:'Kopioi palaute',shared:'Jakaminen avattiin.',copied:'Palaute kopioitu.',technical:'Ilmoita teknisestä virheestä GitHubissa',feedbackPrivacy:'Sverinavilla ei ole palautepalvelinta. Päätät itse, minne teksti lähetetään.'},
  bs:{aboutLabel:'O Sverinavu',title:'O Sverinavu',intro:'Sverinav je nezavisni civic-tech projekat koji olakšava pronalaženje pravog puta kroz javne usluge Švedske.',indTitle:'Nije javna institucija',indText:'Sverinav nije javna institucija i ne predstavlja Grad Göteborg, Trafikverket ili švedski parlament. Službeni predmeti šalju se kroz službu nadležne institucije.',privacyTitle:'Privatnost',privacy1:'Za pilot nije potreban račun ni personnummer.',privacy2:'Lokacija se traži samo kada pokreneš provjeru prema lokaciji i Sverinav je ne čuva.',privacy3:'Izbor jezika čuva se lokalno u pregledniku. Feedback napušta preglednik samo kada ga sam podijeliš.',sourcesTitle:'Izvori',sourcesText:'Live funkcije koriste službene izvore i vode do originala.',version:'Verzija',code:'Javni izvorni kod',feedbackTitle:'Pomozi nam testirati',feedbackIntro:'Ukratko opiši šta si pokušao i šta se desilo. Lokacija se ne dodaje automatski.',task:'Šta si pokušavao?',result:'Je li uspjelo?',yes:'Da',partly:'Djelimično',no:'Ne',notes:'Šta je radilo dobro ili loše?',share:'Podijeli feedback',copy:'Kopiraj feedback',shared:'Otvoren je meni za dijeljenje.',copied:'Feedback kopiran.',technical:'Prijavi tehnički problem na GitHubu',feedbackPrivacy:'Sverinav nema feedback server. Ti biraš gdje se tekst šalje.'},
  ku:{aboutLabel:'Derbarê Sverinav de',title:'Derbarê Sverinav de',intro:'Sverinav projeyek civic-tech ya serbixwe ye ku rêya rast di xizmetên giştî yên Swêdê de hêsan dike.',indTitle:'Ne saziyek fermî ye',indText:'Sverinav ne saziyek fermî ye û Göteborgs Stad, Trafikverket an parlamentoya Swêdê temsîl nake. Karên fermî di xizmeta saziya têkildar de têne şandin.',privacyTitle:'Taybetî',privacy1:'Di pilotê de hesab an personnummer ne pêwîst e.',privacy2:'Cih tenê dema tu kontrola cihî dest pê dikî tê xwestin û Sverinav wê nahilîne.',privacy3:'Hilbijartina ziman di gerokê de tê hilanîn. Feedback tenê dema tu parve dikî derdikeve.',sourcesTitle:'Çavkanî',sourcesText:'Fonksiyonên live çavkaniyên fermî bi kar tînin û girêdana orîjînal didin.',version:'Guherto',code:'Koda çavkaniyê ya giştî',feedbackTitle:'Ji me re test bike',feedbackIntro:'Bi kurtî bêje te çi ceriband û çi qewimî. Dane cihî bixweber nayên zêdekirin.',task:'Te çi dixwest bikî?',result:'Kar kir?',yes:'Erê',partly:'Hinekî',no:'Na',notes:'Çi baş an xerab kar kir?',share:'Feedback parve bike',copy:'Feedback kopî bike',shared:'Menuya parvekirinê vebû.',copied:'Feedback hate kopîkirin.',technical:'Pirsgirêka teknîkî li GitHub rapor bike',feedbackPrivacy:'Sverinav servera feedback tune. Tu hilbijêrî nivîs li ku were şandin.'},
  es:{aboutLabel:'Acerca de Sverinav',title:'Acerca de Sverinav',intro:'Sverinav es un proyecto civic-tech independiente que facilita encontrar el camino correcto en los servicios públicos de Suecia.',indTitle:'No es una autoridad pública',indText:'Sverinav no es una autoridad pública ni representa al Ayuntamiento de Gotemburgo, Trafikverket o el Parlamento sueco. Los trámites oficiales se envían en el servicio de la autoridad correspondiente.',privacyTitle:'Privacidad',privacy1:'El piloto no requiere cuenta ni número personal.',privacy2:'La ubicación solo se solicita cuando inicias una comprobación basada en la ubicación y Sverinav no la guarda.',privacy3:'El idioma se guarda localmente en el navegador. El feedback solo sale del navegador cuando decides compartirlo.',sourcesTitle:'Fuentes',sourcesText:'Las funciones en vivo usan fuentes oficiales y enlazan al original.',version:'Versión',code:'Código fuente público',feedbackTitle:'Ayúdanos a probar',feedbackIntro:'Describe brevemente qué intentaste hacer y qué ocurrió. No se añade ubicación automáticamente.',task:'¿Qué intentabas hacer?',result:'¿Funcionó?',yes:'Sí',partly:'Parcialmente',no:'No',notes:'¿Qué funcionó bien o mal?',share:'Compartir feedback',copy:'Copiar feedback',shared:'Se abrió el menú de compartir.',copied:'Feedback copiado.',technical:'Informar de un problema técnico en GitHub',feedbackPrivacy:'Sverinav no tiene servidor de feedback. Tú eliges dónde se envía el texto.'},
  ru:{aboutLabel:'О Sverinav',title:'О Sverinav',intro:'Sverinav — независимый civic-tech проект, который помогает проще находить нужный путь в государственных и муниципальных сервисах Швеции.',indTitle:'Это не государственный орган',indText:'Sverinav не является myndighet и не представляет Göteborgs Stad, Trafikverket или Riksdagen. Официальное обращение отправляется только в сервисе соответствующего органа.',privacyTitle:'Приватность',privacy1:'В пилоте не нужен аккаунт или personnummer.',privacy2:'Геопозиция запрашивается только после твоего действия для конкретной проверки и Sverinav её не сохраняет.',privacy3:'Выбранный язык хранится локально в браузере. Отзыв покидает браузер только когда ты сам выбираешь его отправить.',sourcesTitle:'Источники',sourcesText:'Live-функции используют официальные источники и всегда ведут к оригиналу.',version:'Версия',code:'Публичный исходный код',feedbackTitle:'Помоги протестировать',feedbackIntro:'Коротко опиши, что пытался сделать и что произошло. Геопозиция в отзыв автоматически не добавляется.',task:'Что ты пытался сделать?',result:'Получилось?',yes:'Да',partly:'Частично',no:'Нет',notes:'Что работало хорошо или плохо?',share:'Поделиться отзывом',copy:'Скопировать отзыв',shared:'Открыто меню отправки.',copied:'Отзыв скопирован.',technical:'Сообщить о технической ошибке на GitHub',feedbackPrivacy:'У Sverinav нет сервера отзывов. Ты сам выбираешь, куда отправить текст.'},
  uk:{aboutLabel:'Про Sverinav',title:'Про Sverinav',intro:'Sverinav — незалежний civic-tech проєкт, який допомагає простіше знаходити потрібний шлях у державних і муніципальних сервісах Швеції.',indTitle:'Це не державний орган',indText:'Sverinav не є myndighet і не представляє Göteborgs Stad, Trafikverket або Riksdagen. Офіційне звернення надсилається лише в сервісі відповідного органу.',privacyTitle:'Приватність',privacy1:'У пілоті не потрібні акаунт або personnummer.',privacy2:'Геопозиція запитується лише після вашої дії для конкретної перевірки й Sverinav її не зберігає.',privacy3:'Обрана мова зберігається локально у браузері. Відгук залишає браузер лише коли ви самі вирішуєте ним поділитися.',sourcesTitle:'Джерела',sourcesText:'Live-функції використовують офіційні джерела й завжди ведуть до оригіналу.',version:'Версія',code:'Публічний вихідний код',feedbackTitle:'Допоможіть протестувати',feedbackIntro:'Коротко опишіть, що намагалися зробити й що сталося. Геопозиція у відгук автоматично не додається.',task:'Що ви намагалися зробити?',result:'Вийшло?',yes:'Так',partly:'Частково',no:'Ні',notes:'Що працювало добре або погано?',share:'Поділитися відгуком',copy:'Скопіювати відгук',shared:'Відкрито меню надсилання.',copied:'Відгук скопійовано.',technical:'Повідомити про технічну помилку на GitHub',feedbackPrivacy:'У Sverinav немає сервера відгуків. Ви самі обираєте, куди надіслати текст.'}
};
...
function feedbackText() {
  const task = document.getElementById('pilotFeedbackTask')?.value.trim() || '—';
  const result = document.getElementById('pilotFeedbackResult')?.value || '—';
  const notes = document.getElementById('pilotFeedbackNotes')?.value.trim() || '—';
  const resultLabel = result === 'yes' ? pmt('yes') : result === 'partly' ? pmt('partly') : result === 'no' ? pmt('no') : '—';

  return [
    'Sverinav pilot feedback',
    `${pmt('version')}: ${APP_VERSION}`,
    `${pmt('task')}: ${task}`,
...
function feedbackStatus(message) {
  const element = document.getElementById('pilotFeedbackStatus');
  if (element) element.textContent = message;
}

async function sharePilotFeedback(button) {
  const text = feedbackText();
  try {
    if (navigator.share) {
      await navigator.share({ title:'Sverinav pilot feedback', text });
...
function aboutScreen() {
  shell(
    ...
    `<div class="about-stack">
      <section class="about-card about-card--notice">
        <span class="item-icon">${icon('consult')}</span>
        <div>
          <h3>${pmt('indTitle')}</h3>
          <p>${pmt('indText')}</p>
      ...
      <section class="about-card about-meta">
        <div><span>${pmt('version')}</span><strong>v${APP_VERSION}</strong></div>
        <a href="${GITHUB_REPO_URL}" target="_blank" rel="noopener noreferrer">${pmt('code')} ↗</a>
      </section>

      <section class="about-card feedback-card">
        <h3>${pmt('feedbackTitle')}</h3>
        <p>${pmt('feedbackIntro')}</p>
        <form id="pilotFeedbackForm">
          <label class="field-label" for="pilotFeedbackTask">${pmt('task')}</label>
          <textarea id="pilotFeedbackTask" class="textarea" rows="3"></textarea>

          <label class="field-label" for="pilotFeedbackResult">${pmt('result')}</label>
          <select id="pilotFeedbackResult" class="input">
            <option value="">—</option>
            <option value="yes">${pmt('yes')}</option>
            <option value="partly">${pmt('partly')}</option>
            <option value="no">${pmt('no')}</option>
          </select>

          <label class="field-label" for="pilotFeedbackNotes">${pmt('notes')}</label>
          <textarea id="pilotFeedbackNotes" class="textarea" rows="4"></textarea>

          <div class="feedback-actions">
            <button id="sharePilotFeedback" class="action" type="button">${pmt('share')}</button>
            <button id="copyPilotFeedback" class="action secondary" type="button">${pmt('copy')}</button>
          </div>
