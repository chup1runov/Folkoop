...
const en={
 ...
 pilot:'FIRST WORKING VERSION',scope:'City tools work. The pilot network now has server-backed profiles, communities, messages and cooperation objects; local drafts remain private and separate.',
...
const sv={...en,
 ...
 pilot:'FÖRSTA FUNGERANDE VERSIONEN',scope:'Stadens verktyg fungerar. Pilotnätverket har nu serverprofiler, grupper, meddelanden och samarbetsobjekt; lokala utkast förblir privata och separata.',
...
const ru={...en,
 ...
 pilot:'ПЕРВАЯ РАБОЧАЯ ВЕРСИЯ',scope:'Городские инструменты работают. В пилоте уже есть серверные профили, сообщества, сообщения и объекты кооперации; локальные черновики остаются приватными и отдельными.',
