...
const files=['city-source.html','folkoop.html','styles.css','compact.css','about-project.css','civic-core.js','daily-data.js','today.js','riksdagen.js','nvdb.js','goteborg-plans.js','app.js','about-copy.js','about-project.js','manifest.webmanifest','sw.js','icon.svg','icon-180.png','icon-192.png','icon-512.png','LICENSE','LICENSING.md','THIRD_PARTY_NOTICES.md','folkoop-core.js','folkoop-copy.js','folkoop.js','folkoop.css','folkoop-city.js','folkoop-mark.png','folkoop-icon-512.png','network-config.js','network-client.js','network-ui.js'];
